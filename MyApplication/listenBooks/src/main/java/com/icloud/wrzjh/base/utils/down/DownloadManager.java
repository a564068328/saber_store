...
public class DownloadManager {
	...
	public long down(Context context, String url, String path, String name) {
		File file = new File(
		...
		request.setDestinationInExternalPublicDir(file.getName(), path);
