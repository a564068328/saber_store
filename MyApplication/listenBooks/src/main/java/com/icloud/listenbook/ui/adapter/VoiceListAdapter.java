...
public class VoiceListAdapter extends
	...
	public VoiceListAdapter(Activity act, ArrayList<ArticleItem> datas) {
		this.act = act;
		this.datas = datas;
	...
	public class GridViewHolder extends RecyclerView.ViewHolder {
		...
		public GridViewHolder(View view) {
			...
			icon.setTag(null);
			icon.setOnClickListener(VoiceListAdapter.this);
			name.setOnClickListener(VoiceListAdapter.this);
	...
	public void onClick(View v) {
		...
		case R.id.icon: {
			LoadingTool.launchActivity(act, VoiceInfoAct.class, Intent);
