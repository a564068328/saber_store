...
public class BookCommentsAdapter extends
	...
	public BookCommentsAdapter(Activity act, Article Item,
			ArrayList<ArticleFeedback> datas) {
		this.act = act;
		this.Item = Item;
	...
	public class VoiceInfoHolder extends RecyclerView.ViewHolder implements
		...
		public void setView(Article Item) {
			...
			heat.setText(res.getString(R.string.heat_to, Item.getClickConut()));
	...
	public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
		...
		if (viewType == Type.TABLE_TITLE) {
			view = LayoutInflater.from(act).inflate(R.layout.book_info_view,
					parent, false);
