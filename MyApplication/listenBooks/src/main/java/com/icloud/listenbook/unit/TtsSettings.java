...
public class TtsSettings extends PreferenceActivity implements OnPreferenceChangeListener {
	...
	private EditTextPreference mVoicePreference;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mVolumePreference = (EditTextPreference)findPreference("voice_preference");
		mVolumePreference.getEditText().addTextChangedListener(new SettingTextWatcher(TtsSettings.this,mVoicePreference,0,15));
	}
