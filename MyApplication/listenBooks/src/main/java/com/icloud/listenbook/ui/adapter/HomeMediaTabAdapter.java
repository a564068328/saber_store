...
public class HomeMediaTabAdapter extends
	...
	public HomeMediaTabAdapter(Activity act, ArrayList<String> data, int index) {
		this.data = data;
		this.act = act;
		this.index = index;
	...
	public class ItemHolder extends RecyclerView.ViewHolder implements
		...
		public void onClick(View v) {
			...
			HomeMediaTabAdapter.this.notifyDataSetChanged();
		}
	}
