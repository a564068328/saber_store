package com.icloud.listenbook.base.view.lableview;
...
public class LableNetworkImageView extends NetworkImageView {
	LabelViewHelper utils;

	public LableNetworkImageView(Context context) {
		this(context, null);
	}

	public LableNetworkImageView(Context context, AttributeSet attrs) {
