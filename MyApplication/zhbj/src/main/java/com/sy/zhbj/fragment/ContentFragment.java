...
import com.sy.zhbj.base.impl.GovAffairsPager;
import com.sy.zhbj.base.impl.HomePager;
import com.sy.zhbj.base.impl.NewsCenterPager;
import com.sy.zhbj.base.impl.SettingPager;
import com.sy.zhbj.base.impl.SmartServicePager;
...
public class ContentFragment extends BaseFragment {
	...
	class ContentAdapter extends PagerAdapter {
		...
		public Object instantiateItem(ViewGroup container, int position) {
			...
			// pager.initData();// 初始化数据.... 不要放在此处初始化数据, 否则会预加载下一个页面，从而导致一些问题
