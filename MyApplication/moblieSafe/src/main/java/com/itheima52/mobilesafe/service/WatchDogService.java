...
/**
 * 程序锁的看门狗服务，需要权限<uses-permission android:name="android.permission.GET_TASKS" />
 */
public class WatchDogService extends Service {
	...
	public void onCreate() {
		...
		//注册内容观察者监听程序锁数据库是否变化
		getContentResolver().registerContentObserver(Uri.parse("content://com.applockchange"), true, new appLockContentObserver(new Handler()));
